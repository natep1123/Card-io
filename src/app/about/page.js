      ...
      <div className="text-left flex flex-col gap-4">
        ...
        <div className="flex flex-col gap-4 rounded-lg bg-gray-800 p-4">
          ...
          <p>
            ...
            ChatGPT's gpt-4.1. It will retrieve your most recent saved workout
            stats (up to 5) and generate insights into the trends of your data.
          </p>
          <p>
            ...
            generated workouts to your clipboard to easily paste into your
